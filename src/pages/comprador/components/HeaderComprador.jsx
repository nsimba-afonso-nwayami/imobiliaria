...
export default function HeaderComprador({ sidebarOpen, setSidebarOpen, title }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 sm:gap-5">
        ...
        {/* MENSAGENS */}
        <Link to="/dashboard/comprador/mensagens" className={actionBtnStyle}>
          <i className="fas fa-comment-dots text-lg"></i>
          <span className={badgeStyle}>3</span>
        </Link>

        {/* NOTIFICAÇÕES */}
        <Link to="/dashboard/comprador/notificacoes" className={actionBtnStyle}>
