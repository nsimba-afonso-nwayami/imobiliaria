    ...
    <CompradorLayout title="Catálogo de Ativos">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        {filteredImoveis.map((imovel) => (
          <div 
            key={imovel.id}
            className="group bg-white rounded-[2rem] border border-neutral-100 overflow-hidden shadow-sm hover:shadow-[0_30px_60px_rgba(2,6,23,0.1)] transition-all duration-700"
          >
