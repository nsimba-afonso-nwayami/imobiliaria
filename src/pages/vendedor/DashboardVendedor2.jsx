...
export default function DashboardVendedor() {
  ...
  const showBedrooms = ["house", "apartment", "office"].includes(propertyType);

  const showBathrooms = ["house", "apartment", "office"].includes(propertyType);

  const showGarages = ["house", "office"].includes(propertyType);

  const showFurnished = ["house", "apartment", "office"].includes(propertyType);
